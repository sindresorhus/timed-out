...
const port = Math.floor((Math.random() * (60_000 - 30_000)) + 30_000);
...
test('should do HTTP request with a lot of time', async () => {
...
test('should emit ETIMEDOUT when connection timeout expires', async () => {
	await new Promise((resolve, reject) => {
...
describe('when connection is established', () => {
	...
	test('should emit ESOCKETTIMEDOUT (no data)', async () => {
		await new Promise((resolve, reject) => {
			server.once('request', () => {});
	...
	test('should emit ESOCKETTIMEDOUT (only first chunk of body)', async () => {
		await new Promise((resolve, reject) => {
	...
	test('should be able to only apply connect timeout', async () => {
		await new Promise((resolve, reject) => {
			server.once('request', (request, response) => {
				setTimeout(() => {
	...
	test('should be able to only apply socket timeout', async () => {
		await new Promise((resolve, reject) => {
			server.once('request', (request, response) => {
				setTimeout(() => {
					response.writeHead(200);
	...
	test('should not add event handlers twice for the same socket', async () => {
		await new Promise((resolve, reject) => {
	...
	test('should set socket timeout if socket is already connected', async () => {
		await new Promise((resolve, reject) => {
			server.once('request', () => {});
	...
	test('should clear socket timeout for keep-alive sockets', async () => {
		await new Promise((resolve, reject) => {
			server.once('request', (request, response) => {
				response.writeHead(200);
				response.end('data');
